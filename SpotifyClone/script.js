...
let N = [
    ...
    {name:"Time",path:"../songs/NF - Time.mp3",cover:"https://upload.wikimedia.org/wikipedia/en/8/84/NF_-_Hope.png",artistName:"Seedhe Maut"},
    {name:"Hate myself",path:"../songs/NF - Hate Myself (Audio).mp3",cover:"https://upload.wikimedia.org/wikipedia/en/8/84/NF_-_Hope.png",artistName:"Seedhe Maut"},
 ]
 let NF = [
